...
// import { Flex, FormatLargeNumber } from '@ball/core';
...
function prepareGraphPoints(
  ...
  */
  ...
  const points = [
    {
      x: peak.height,
      y: Math.max(0, mojo_to_ball(start)),
      tooltip: mojo_to_ball(balance),
    },
  ];
      ...
      <ResponsiveLine
        ...
        defs={[
          linearGradientDef('gradientA', [
            { offset: 0, color: '#3aac59' },
            { offset: 100, color: '#3aac59', opacity: 0 },
          ]),
        ]}
