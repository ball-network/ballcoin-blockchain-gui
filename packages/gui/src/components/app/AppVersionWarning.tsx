import { Button, Flex } from '@ball-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Ball application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Ball services version: {backV}
                <br />
                Ball application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Ball application and stop all Ball services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
