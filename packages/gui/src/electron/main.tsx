...
import { NFTInfo } from '@ball-network/api';
...
import AppIcon from '../assets/img/ball64x64.png';
...
// Set the userData directory to its location within BALL_ROOT/gui
setUserDataDir();
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'BallCoin Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/Ball-Network/ballcoin-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/Ball-Network/ballcoin-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/Ball-Network/ballcoin-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/Ball-Network/ballcoin-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/Ball-Network/ballcoin-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/ball');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/ball_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // BallCoin Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'Ball' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About BallCoin Blockchain' }),
          click: () => {
            openAbout();
          },
        },
