import { Connection, ServiceConnectionName } from '@ball-network/api';
import { useGetWalletConnectionsQuery } from '@ball-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@ball-network/core';
