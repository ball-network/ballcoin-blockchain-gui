import { useGetOfferSummaryMutation } from '@ball-network/api-react';
import { Color, Dropzone, Flex, useSerializedNavigationState, useShowError } from '@ball-network/core';
