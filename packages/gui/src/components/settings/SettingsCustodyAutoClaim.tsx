import { useGetAutoClaimQuery, useSetAutoClaimMutation } from '@ball-network/api-react';
import { Flex, SettingsText, Form, ButtonLoading, Fee, ballToMojo, mojoToBall } from '@ball-network/core';
import { ConnectCheckmark } from '@ball-network/icons';
...
export default function SettingsCustodyAutoClaim(props) {
  ...
  const autoClaimFee = autoClaimData?.txFee ? mojoToBall(autoClaimData.txFee).toNumber() : 0;
