...
import { ballToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@ball-network/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = ballToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Ball Asset Token Wallet</Trans>
        </Back>
        <Card>
