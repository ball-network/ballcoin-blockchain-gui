...
export type { default as CalculateRoyaltiesRequest } from './CalculateRoyaltiesRequest';
export type { default as CalculateRoyaltiesResponse } from './CalculateRoyaltiesResponse';
