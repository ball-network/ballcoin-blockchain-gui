...
import { Flex, SettingsHR, SettingsSection, SettingsText } from '@ball-network/core';
...
export default function SettingsCustody() {
  ...
  return (
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      ...
      <Box>
        <SettingsSection>
          <Trans>Default claw back time for outgoing BALL transactions</Trans>
        </SettingsSection>

        <SettingsText>
          <Trans>Set a default time frame for all outbound BALL transactions.</Trans>
        </SettingsText>
