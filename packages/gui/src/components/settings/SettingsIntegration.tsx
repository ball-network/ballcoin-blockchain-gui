import { Flex, MenuItem, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@ball-network/core';
                ...
                <Grid item container style={{ width: '400px' }} gap={2}>
                  <SettingsText>
                    <Trans>
                      ...
                      command issued by the Dapp will require confirmation in the Ball wallet.
                    </Trans>
                  </SettingsText>
                </Grid>
              </>
