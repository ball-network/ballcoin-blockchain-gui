...
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@ball-network/api-react';
import { Button, Flex, Form, TextField, Loading } from '@ball-network/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25BALL reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
