import { useGetKeysQuery, useGetLoggedInFingerprintQuery, usePrefs } from '@ball-network/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToBall.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const mainnet = useCurrencyCode() === 'BALL';
