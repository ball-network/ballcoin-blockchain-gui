import { NewFarmingInfo } from '@ball-network/api';
import { useGetBlockchainStateQuery, useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@ball-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple, useCurrencyCode } from '@ball-network/core';
...
export default function HarvesterOverview() {
  ...
  const isTestnet = (useCurrencyCode() ?? 'BALL').toUpperCase() === 'TBALL';
