import { TransactionType } from '@ball-network/api';
import type { Transaction } from '@ball-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@ball-network/api-react';
import { useTrans, Button } from '@ball-network/core';
