import { useRefreshPlotsMutation } from '@ball-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@ball-network/core';
import { Plots } from '@ball-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Ball. &nbsp;
              <Link target="_blank" href="https://github.com/Ball-Network/ballcoin-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
