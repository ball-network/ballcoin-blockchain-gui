import * as ballCore from '@ball-network/core';
...
describe('createOfferForIdsToOfferBuilderData', () => {
  ...
  describe('when offering BALL for CAT', () => {
    it('should return a valid offer builder data object', () => {
      ...
      ballCore.mojoToBall.mockReturnValue(new BigNumber(111.555));
      ballCore.mojoToCAT.mockReturnValue(new BigNumber(600));
  ...
  describe('when offering a CAT for BALL', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      ballCore.mojoToBall.mockReturnValue(new BigNumber(2));
      ballCore.mojoToCAT.mockReturnValue(new BigNumber(1.234));
  ...
  describe('when offering BALL for an NFT', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      ballCore.mojoToBall.mockReturnValue(new BigNumber(3));
  ...
  describe('when the offered asset is for an unknown wallet type', () => {
    it('should ignore the unknown wallet assets', () => {
      ...
      ballCore.mojoToBall.mockReturnValue(new BigNumber(0.5));
  ...
  describe('when lookupByWalletId throws', () => {
    ...
    it('should ignore the asset that caused the error', () => {
      ...
      ballCore.mojoToBall.mockReturnValue(new BigNumber(5));
      ballCore.mojoToCAT.mockReturnValue(new BigNumber(1000));
