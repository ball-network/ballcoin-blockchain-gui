...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@ball-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.ballcoin.vip/faq/#why-does-my-ball-farm-say-missing-signage-points">
