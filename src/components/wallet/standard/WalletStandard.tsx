...
import { /* mojo_to_ball_string, */ ball_to_mojo } from '../../../util/ball';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_ball_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of ball in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Ball that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Ball that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send ball to coloured address. Please enter a ball
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    const amountValue = Number.parseFloat(ball_to_mojo(amount));
    const feeValue = Number.parseFloat(ball_to_mojo(fee));
