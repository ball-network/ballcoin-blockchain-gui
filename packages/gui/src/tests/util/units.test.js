...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of ball', () => {
      const result = units.getUnit('ball');
    ...
    it('gets unit of ballcoin using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of ball', () => {
      const result = units.getDisplay('ball');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('ball', 9);

      const result = units.getUnit('ball');

      expect(result).toEqual(9);

      units.setUnit('ball', 1);
    });
  });
  describe('#setDisplay', () => {
