import { defaultPlotter, toBech32m, fromBech32m } from '@ball-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@ball-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@ball-network/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.BALLPOS),
  });
