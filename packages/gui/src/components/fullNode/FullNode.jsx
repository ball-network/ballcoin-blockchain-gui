import { useGetLatestBlocksQuery, useGetUnfinishedBlockHeadersQuery } from '@ball-network/api-react';
import { FormatLargeNumber, Flex, Card, StateColor, Table, LayoutDashboardSub } from '@ball-network/core';
import { Status } from '@ball-network/icons';
