...
import { CardStep, Select, StateColor } from '@ball-network/core';
import { useGetPlottersQuery } from '@ball-network/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@ball-network/api';
import type { Plotter, PlotterMap } from '@ball-network/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.BALLPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Ball Proof of Space plotter. If unsure,
            use the default Ball Proof of Space plotter.
        </Trans>
      </Typography>
