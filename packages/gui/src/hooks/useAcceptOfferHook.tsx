import type { OfferSummaryRecord, Wallet } from '@ball-network/api';
import { useTakeOfferMutation } from '@ball-network/api-react';
import { AlertDialog, ballToMojo, useOpenDialog, useShowError } from '@ball-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? ballToMojo(fee) : new BigNumber(0);
